...
$(BUILD)/main.o: src/main.asm src/vdp.asm src/input.asm src/psg.asm src/engine.asm src/sample.asm src/editor.asm $(BUILD)/font.bin $(BUILD)/demo.bin $(BUILD)/notes.inc $(BUILD)/pool.inc | $(BUILD)
	$(ASM) -I $(BUILD) -o $@ src/main.asm

$(BUILD)/main-gg.o: src/main.asm src/vdp.asm src/input.asm src/psg.asm src/engine.asm src/sample.asm src/editor.asm $(BUILD)/font.bin $(BUILD)/demo.bin $(BUILD)/notes.inc $(BUILD)/pool.inc | $(BUILD)
